...
### Library: https://github.com/neomatrix369/nlp_profiler
...
def apply_text_profiling(dataframe, text_column, params={}):
    message = """
        Moved to a new location, install and use from https://github.com/neomatrix369/nlp_profiler,
        read the README.md to learn more and also see https://github.com/neomatrix369/nlp_profiler/blob/master/notebooks/jupyter/nlp_profiler.ipynb.
    """
