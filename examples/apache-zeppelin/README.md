# 🖥️ Apache Zeppelin [![Zeppelin](https://img.shields.io/docker/pulls/neomatrix369/zeppelin.svg)](https://hub.docker.com/r/neomatrix369/zeppelin) [![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)
...
## At a glance
- **Polyglot notebooks**: JVM and non-JVM interpreters
- **Docker-ready**: build and run images locally
- **Guides**: local install, Docker, building, pushing
