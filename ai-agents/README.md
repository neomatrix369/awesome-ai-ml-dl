...
*   **[NeuroLink](https://github.com/juspay/neurolink):** Open-source TypeScript-first AI SDK for building AI-powered applications. Provides a unified API for 200+ models, RAG pipelines, AI agent orchestration, and built-in observability — designed for production use.
