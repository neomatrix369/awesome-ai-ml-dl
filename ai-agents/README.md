...
*   **[Autonomous Agents](https://github.com/KeepALifeUS/autonomous-agents):** Production multi-agent orchestration system using stigmergy pattern. Features 4 specialized agents (Sales, Scheduler, Analyst, Coordinator) that coordinate through shared environment instead of direct messages, achieving 80% reduction in API token usage. Built with Claude API and TypeScript.
*   **[NeuroLink](https://github.com/juspay/neurolink):** Open-source TypeScript-first AI SDK for building AI-powered applications. Provides a unified API for 13 major AI providers and 100+ models, RAG pipelines, AI agent orchestration, and built-in observability — designed for production use.
