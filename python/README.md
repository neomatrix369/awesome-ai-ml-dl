...
- [Coding Ground: Execute Python Online](https://www.tutorialspoint.com/execute_python_online.php)
...
- [Scalene](https://github.com/emeryberger/scalene) - High-performance CPU/GPU/memory profiler
...
### Web Frameworks
- [Streamlit](https://streamlit.io/) - Fastest way to build custom ML tools
...
- [TensorFlow](https://www.tensorflow.org/) - End-to-end open source platform
- [PyTorch](https://pytorch.org/) - Deep learning framework
- [Keras](https://keras.io/) - High-level neural networks API
- [XGBoost](https://xgboost.readthedocs.io/en/latest/) - Gradient boosting framework
- [LightGBM](https://lightgbm.readthedocs.io/en/latest/) - Gradient boosting framework
...
- [pylint](https://github.com/PyCQA/pylint) - Code analysis tool
...
- [nose2](https://nose2.readthedocs.io/) - Test runner
...
Contributions are very welcome! Please see our [Contributing Guidelines](../CONTRIBUTING.md) and [Licensing Policy](../LICENSE.md).
